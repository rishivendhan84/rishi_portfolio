...
export class PortfolioGame {
  ...
  _buildDom() {
    ...
    root.innerHTML = `
      ...
      <div class="game__hud">
        <button class="game__exit" type="button" title="Exit game (Esc)">✕ <span>Exit</span></button>
        <div class="game__track">
          <div class="game__track-fill"></div>
          <div class="game__track-dots"></div>
        </div>
        <div class="game__right">
          <span class="game__cores"><i>⬢</i> <b class="game__cores-n">0</b>/<span class="game__cores-t">0</span></span>
          <button class="game__mute" type="button" title="Toggle sound">♪</button>
        </div>
      </div>

      <div class="game__zone" aria-live="polite"></div>
      <div class="game__toast" aria-hidden="true"></div>

      <div class="game__hint">
        <span class="game__hint-desktop"><kbd>◀</kbd><kbd>▶</kbd> steer &nbsp;·&nbsp; <kbd>W</kbd> boost &nbsp;·&nbsp; <kbd>Esc</kbd> exit</span>
        <span class="game__hint-touch">Drag to steer · your ship flies itself</span>
      </div>

      <div class="game__panel" hidden>
        <div class="gpanel"></div>
      </div>

      <div class="game__screen game__screen--intro">
        <p class="game__screen-kicker">Rishi Vendhan K K presents</p>
        <h1 class="game__screen-title">PORTFOLIO<span>:</span> THE&nbsp;PATHWAY</h1>
        ...
        <button class="game__start" type="button">▶ &nbsp;Start the run</button>
      ...
      <div class="game__screen game__screen--end" hidden>
        <p class="game__screen-kicker">Run complete</p>
        <h1 class="game__screen-title">LET’S BUILD<br/>SOMETHING <span class="game__screen-accent">REAL</span></h1>
        <div class="game__end-stats"></div>
        ...
        <div class="game__end-actions">
          <button class="game__start game__replay" type="button">↻ &nbsp;Run it again</button>
    ...
    this.el = {
      ...
      coresN: root.querySelector('.game__cores-n'),
      coresT: root.querySelector('.game__cores-t'),
      zone: root.querySelector('.game__zone'),
      toast: root.querySelector('.game__toast'),
      ...
      endStats: root.querySelector('.game__end-stats'),
      hint: root.querySelector('.game__hint'),
  ...
  _panelHTML(cp) {
    ...
    return `
      ...
      ${stats}${tags}${link}
      <button class="game__start gpanel__continue" type="button">Continue the run &nbsp;<kbd>Enter</kbd></button>
    `;
  }
  ...
  _bind() {
    ...
    this.root.querySelector('.game__start').addEventListener('click', () => this._startRun());
